...
import { Mid1SupaBlog_74, Mid2NodeBlogLocal_74, Mid2NodeBlogSupa_74} from './pages/mid1_74';
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: 'mid2BlogLocal_74',
        element: <Mid2NodeBlogLocal_74 />,
      },
      {
        path: 'mid2BlogSupa_74',
        element: <Mid2NodeBlogSupa_74 />,
      },
      {
        path: 'demoGetBlog_74',
