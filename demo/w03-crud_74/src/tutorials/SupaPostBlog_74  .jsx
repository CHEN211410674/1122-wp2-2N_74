...
let api_url ='https://sgtwgxsjtbibcbrzrfra.supabase.co/rest/v1/card_74';

  const SupaPostBlog_74 = () => {
  ...
  const fetchBlogsFromSupabase = async () => {
    try {
      const response = await axios.post(
        ...
        {
          "id": 12,
          "title": "CHEN Yi-Zhen 211410674",
          "descrip": "Lorem ipsum dolor, sit amet consectetur adipisicing elit.",
          "category": "TRAVEL",
          "img": "https://sgtwgxsjtbibcbrzrfra.supabase.co/storage/v1/object/public/demo/1122/fran-eP-47yxVScA-unsplash.jpg",
          "remote_url": ""
        },{
        headers:{
...
export default SupaPostBlog_74;